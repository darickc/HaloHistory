    ...
    public static class AutoMapperConfiguration
    {
        public static void Configure()
        {
            Mapper.Initialize(x =>
            {
                ...
                x.CreateMap<ArenaMatch, MatchResult>()
                    .ForMember(d => d.MatchDuration, opt => opt.MapFrom(s => s.TotalDuration.ToString(@"hh\:mm\:ss")));
                x.CreateMap<CustomMatch, MatchResult>()
                    .ForMember(d => d.MatchDuration, opt => opt.MapFrom(s => s.TotalDuration.ToString(@"hh\:mm\:ss")));
                x.CreateMap<CampaignMatch, MatchResult>()
                    .ForMember(d => d.MatchDuration, opt => opt.MapFrom(s => s.TotalDuration.ToString(@"hh\:mm\:ss")));
                x.CreateMap<WarzoneMatch, MatchResult>()
                    .ForMember(d => d.MatchDuration, opt => opt.MapFrom(s => s.TotalDuration.ToString(@"hh\:mm\:ss")));
                ...
                x.CreateMap<HaloSharp.Model.Metadata.Weapon, WeaponKill>();
