...
namespace HaloSharp.Model.Stats
{
    ...
    public class Result : IEquatable<Result>
    {
        ...
        [JsonProperty(PropertyName = "GameBaseVariant")]
        ...
        [JsonProperty(PropertyName = "GameVariantInfo")]
        public GameVariant GameVariantInfo { get; set; }
        ...
        [JsonProperty(PropertyName = "MapVariantInfo")]
        public MapVariant MapVariantInfo { get; set; }
