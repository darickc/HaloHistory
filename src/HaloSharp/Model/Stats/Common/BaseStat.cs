...
{
    //[Serializable]
    public class BaseStat : IEquatable<BaseStat>, IBaseStat
    {
        /// <summary>
    ...
    public class Impulse : IEquatable<Impulse>
    {
        ...
        public Metadata.Impulse ImpulseItem { get; set; }
    ...
    public class Enemy : IEquatable<Enemy>
    {
        ...
        public Metadata.Enemy EnemyObject { get; set; }

        public Metadata.Vehicle Vehicle { get; set; }
