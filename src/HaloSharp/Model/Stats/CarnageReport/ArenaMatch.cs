...
{
    //[Serializable]
    public class ArenaMatch : BaseMatch, IEquatable<ArenaMatch>, ITeamMatch
    {
        /// <summary>
    ...
    //[Serializable]
    public class ArenaMatchPlayerStat : BasePlayerStat, IEquatable<ArenaMatchPlayerStat>, ICompetetivePlayer, IPlayer
    {
        /// <summary>
        ...
        public SpartanRank CurrentSpartanRank { get; set; }
        public SpartanRank NextSpartanRank { get; set; }
