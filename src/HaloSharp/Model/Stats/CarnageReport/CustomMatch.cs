...
{
    //[Serializable]
    public class CustomMatch : BaseMatch, IEquatable<CustomMatch>, ITeamMatch
    {
        /// <summary>
    ...
    //[Serializable]
    public class CustomMatchPlayerStat : BasePlayerStat, IEquatable<CustomMatchPlayerStat>, IPlayer
    {
        /// <summary>
